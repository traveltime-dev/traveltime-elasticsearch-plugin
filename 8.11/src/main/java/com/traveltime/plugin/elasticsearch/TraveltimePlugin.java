...
public class TraveltimePlugin extends Plugin implements SearchPlugin {
    ...
    public Collection<Object> createComponents(
        ...
        return super.createComponents(client, clusterService, threadPool, resourceWatcherService, scriptService, xContentRegistry, environment, nodeEnvironment, namedWriteableRegistry, indexNameExpressionResolver, repositoriesServiceSupplier, telemetryProvider, allocationService, indicesService);
